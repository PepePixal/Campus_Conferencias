<div class="evento">
    ...
    <div class="evento__informacion">
        ...
        <div class="evento__autor-info">
            <picture>
                <!-- la var super glob $_ENV['HOST'] contiene HOST definido en .env  -->
                ...
                <img class=evento__imagen-autor loading="lazy" width="200" height="300" src="<?php echo $_ENV['HOST']; ?>/img/speakers/<?php echo $evento->ponente->imagen; ?>.png" type="image/png" alt="imagen ponente">
            </picture>
        ...
        >
            <?php echo ($evento->disponibles === "0") ? 'Agotada' : $evento->disponibles . ' Disponibles' . ' - Agregar'; ?>
