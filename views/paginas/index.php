            ...
            <div class="speaker__informacion">
                ...
                <nav class="speaker__sociales">
                    ...
                    <?php if(!empty($redes->facebook)) { ?>
                        <a class="speaker__enlace" rel="noopener noreferrer" target="blank " href="<?php echo $redes->facebook; ?>">
                            <span class="speaker__olcultar">Facebook</span>    
                        </a>
                    <?php } ?>

                    <?php if(!empty($redes->twitter)) { ?>
                        <a class="speaker__enlace" rel="noopener noreferrer" target="blank " href="<?php echo $redes->twitter; ?>">
                            <span class="speaker__olcultar">Twitter</span>    
                        </a>
                    <?php } ?>
                    
                    <?php if(!empty($redes->youtube)) { ?>
                        <a class="speaker__enlace" rel="noopener noreferrer" target="blank " href="<?php echo $redes->youtube; ?>">
                            <span class="speaker__olcultar">Youtube</span>    
                        </a>
                    <?php } ?>
                    
                    <?php if(!empty($redes->instagram)) { ?>
                        <a class="speaker__enlace" rel="noopener noreferrer" target="blank " href="<?php echo $redes->instagram; ?>">
                            <span class="speaker__olcultar">Instagram</span>    
                        </a>
                    <?php } ?>

                    <?php if(!empty($redes->tiktok)) { ?>
                        <a class="speaker__enlace" rel="noopener noreferrer" target="blank " href="<?php echo $redes->tiktok; ?>">
                            <span class="speaker__olcultar">Tiktok</span>    
                        </a>
                    <?php } ?>

                    <?php if(!empty($redes->github)) { ?>
                        <a class="speaker__enlace" rel="noopener noreferrer" target="blank " href="<?php echo $redes->github; ?>">
                            <span class="speaker__olcultar">Github</span>    
                        </a>
                    <?php } ?>
                </nav>
            </div>
