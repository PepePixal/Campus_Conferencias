<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            <a href="/"><h3 class="footer__logo">&#60;CampusDevWeb /></h3></a>

            <p class="footer__texto">
                CampusDEvWeb es una conferencia para desarrolladores de todos los nieveles, en la que puedes participar de forma presncial o en línea.
            </p>
        </div>
