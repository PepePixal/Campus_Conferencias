...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $mail->setFrom('cuentas@CampusDevWeb.com');
         ...
         $contenido = '<html>';
         $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en CampusDevWeb; pero es necesario confirmarla</p>";
